                  ...
                  if (address) {
                    await fetch('/api/calls', {
                      ...
                      body: JSON.stringify({
                        ...
                        topic: channel.context || 'General Support',
                        hostAddress: address,
                        transcript: transcript,
                        duration: 0, // Could calculate real duration
                        hasHumanDevRel: participants.some(p => p.role === 'Human')
                      })
                    });
                  }
                } catch (e) {
                  console.error('Failed to save call to DB', e);
                }
